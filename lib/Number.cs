namespace eV.Measure
{
    ...
    public partial class Number : IQuantity<Number>, IMeasure<Number>, IEquatable<Number>, IComparable<Number>
    {
        ...
        /// Gets the standard unit associated with the quantity
        /// </summary>
        public IUnit<Number> StandardUnit => One;

        /// <summary>
        /// Gets the measure factory associated with the quantity.
        /// </summary>
        IMeasureFactory<Number> IQuantity<Number>.Factory => factory;
        ...
        IMeasure IMeasure.this[IUnit unit] => this[unit as IUnit<Number>];

        /// <summary>
        /// Gets the quantity-typed unit of measure
        /// </summary>
        /// <remarks>Always return the standard unit of measure</remarks>
        public IUnit<Number> Unit => this.StandardUnit;
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        IMeasure<Number> IMeasure<Number>.this[IUnit<Number> unit] => this[unit];
